...
| 09 | [Fastify plugin architecture](09-fastify-plugin-architecture.md) | Costura no repositório, plugins com autoload e decorators, sem mudança de comportamento |
